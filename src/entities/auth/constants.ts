...
export enum ErrorMessages {
  ...
  DUPLICATE_ERROR = 'already exists with this',
  ...
  INVALID_OPERATION_NAME = 'Invalid operation name (Malformed query/mutation name. It must describe the operation and contain the entity name).',
}
